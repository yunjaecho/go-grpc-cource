...
func (*Greeting) Descriptor() ([]byte, []int) {
	return fileDescriptor_greet_2bdfd92029661ad3, []int{0}
}
...
func (*GreetRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_greet_2bdfd92029661ad3, []int{1}
}
...
func (*GreetResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_greet_2bdfd92029661ad3, []int{2}
}
...
func (*GreetManyTimesRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_greet_2bdfd92029661ad3, []int{3}
}
...
type GreetManyTimesRespnse struct {
	Result               string   `protobuf:"bytes,1,opt,name=result,proto3" json:"result,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
...
func (m *GreetManyTimesRespnse) Reset()         { *m = GreetManyTimesRespnse{} }
func (m *GreetManyTimesRespnse) String() string { return proto.CompactTextString(m) }
func (*GreetManyTimesRespnse) ProtoMessage()    {}
func (*GreetManyTimesRespnse) Descriptor() ([]byte, []int) {
	return fileDescriptor_greet_2bdfd92029661ad3, []int{4}
}
func (m *GreetManyTimesRespnse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_GreetManyTimesRespnse.Unmarshal(m, b)
}
func (m *GreetManyTimesRespnse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_GreetManyTimesRespnse.Marshal(b, m, deterministic)
}
func (dst *GreetManyTimesRespnse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GreetManyTimesRespnse.Merge(dst, src)
}
func (m *GreetManyTimesRespnse) XXX_Size() int {
	return xxx_messageInfo_GreetManyTimesRespnse.Size(m)
}
func (m *GreetManyTimesRespnse) XXX_DiscardUnknown() {
	xxx_messageInfo_GreetManyTimesRespnse.DiscardUnknown(m)
}

var xxx_messageInfo_GreetManyTimesRespnse proto.InternalMessageInfo

func (m *GreetManyTimesRespnse) GetResult() string {
	if m != nil {
		return m.Result
	}
	return ""
...
func (*LongGreetRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_greet_2bdfd92029661ad3, []int{5}
}
...
func (*LongGreetResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_greet_2bdfd92029661ad3, []int{6}
}
...
func init() {
	...
	proto.RegisterType((*GreetManyTimesRespnse)(nil), "greet.GreetManyTimesRespnse")
...
type GreetService_GreetManyTimesClient interface {
	Recv() (*GreetManyTimesRespnse, error)
	grpc.ClientStream
}
...
func (x *greetServiceGreetManyTimesClient) Recv() (*GreetManyTimesRespnse, error) {
	m := new(GreetManyTimesRespnse)
...
type GreetService_GreetManyTimesServer interface {
	Send(*GreetManyTimesRespnse) error
	grpc.ServerStream
}
...
func (x *greetServiceGreetManyTimesServer) Send(m *GreetManyTimesRespnse) error {
...
func init() { proto.RegisterFile("greet/greetpb/greet.proto", fileDescriptor_greet_2bdfd92029661ad3) }

var fileDescriptor_greet_2bdfd92029661ad3 = []byte{
	...
	,
}
